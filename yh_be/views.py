...
def index(request):
    ...
    if 'keyword' in request.GET:
        ...
        bu_items = BusinessEntity.objects.filter(libelle__icontains=keyword)  # like %keyword%
    else:
...
def create(request):
    # create BusinessEntityForm object fill with inputs if the request method is post or None else
